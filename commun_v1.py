...
def calculer_commande_auto(tableau_lidar_filtre, L_entraxe, W_empattement, maxangle_degre,
    ...
    d_front = lire_point_lidar_front(tableau_lidar_filtre, angle_front, fenetre_deg=4, min_points=2)
    ...
    # =========================
    w_g = np.array([1.2,  0.8,  0.8, -2, -0.6, -0.6])
    w_d = np.array([1.2, -0.6, -0.6, -2,  0.8,  0.8])
